...
它不是通用绘画 prompt，也不是复杂的海报排版模板。它的核心目标是：先理解用户输入的一句话情绪或生活场景，再自动匹配小紫鸽的表情、道具、背景配色和治愈文案，最后组装成一段可以直接复制到 ChatGPT / 即梦等图像工具里的中文提示词。

默认视觉 IP 是 Fun Fun Pigeon 小紫鸽：一个圆滚滚的薰衣草紫水滴形角色，戴蓝色毛绒耳机，有黄色小三角嘴、黑色小圆点眼睛、短小翅膀和软糯的手绘质感。
